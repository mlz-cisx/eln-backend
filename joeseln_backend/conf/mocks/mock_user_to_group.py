...
from joeseln_backend.services.user_to_group.user_to_group_service import get_group_by_groupname
...
test_user = get_user_by_uname(db=my_session,username='wb_test_1')
