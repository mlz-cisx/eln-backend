...
def restore_picture_version(db: Session, picture_pk, version_pk, user):
    ...
    canvas_content = version_metadata['canvas_content']
...
def add_picture_version(db: Session, picture_pk, summary, user,
    ...
    if pic_to_test:
        ...
        if check_for_labbook_access(db=db, labbook_pk=lb_elem.labbook_id,
            ...
            if restored_title is not None or restored_canvas_content is not None:
                if restored_canvas_content is not None:
                    db_picture.canvas_content = restored_canvas_content
            ...
            version_metadata = {
                ...
                'canvas_content': db_picture.canvas_content
            }
