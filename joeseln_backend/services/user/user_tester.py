from joeseln_backend.conf.mocks.mock_user import TEST_USER_1
...
test_user = get_user_by_uname(db=my_session, username='admin')
print(verify_password('secret', User.parse_obj(test_user).password))
